...
### 3.3.2 Unified Interpretation in the Present Theory: Moderate Metacognition

In the present theoretical framework, AuDHD is **not** understood as a simple combination of two disorders. Instead, it is reconceptualized as a **state characterized by a moderate level of metacognition**.

Metacognition at a moderate level entails that individuals:

* partially understand their own cognitive style,
* partially understand social and institutional demands,
* attempt to regulate or translate between the two,
* but are unable to do so fully or automatically.

This partial understanding, combined with incomplete control, constitutes the structural core of AuDHD.

### 3.3.3 Non-Hierarchical Cognition with Incomplete Translation Layers

#### Structural Configuration

In the most common form of AuDHD, individuals are **innately non-hierarchical in their cognitive organization**, while possessing a moderate level of metacognition. This allows them to recognize that their natural cognitive processing is mismatched with the demands of a hierarchically structured society.

As a result, they attempt to construct a **translation layer**—a consciously learned interface that converts non-hierarchical cognition into hierarchically acceptable outputs (e.g., structured language, explicit rules, rigid routines).

However, because metacognition does not reach a high level, this translation layer remains **incomplete and unstable**.

#### Manifestations of Incompleteness

This structural instability produces a distinctive combination of features:

**ADHD-related features (non-hierarchical cognitive base):**

* parallel processing in which all information competes equally for attention,
* associative and rapidly shifting thought patterns,
* improvisational responses rather than planned action,
* fluid and unstable time perception centered on the present moment.

**ASD-related features (attempted translation layer):**

* strong adherence to explicit rules learned from the environment,
* excessive systematization as a compensatory strategy,
* reliance on memorized social scripts,
* preference for predictability and routine to reduce cognitive uncertainty.

These two sets of features coexist not as independent traits, but as **structural consequences of incomplete translation**.

### 3.3.4 Chronic Internal Conflict and Accumulated Translation Cost

Because the translation layer cannot be fully automated, individuals with AuDHD must rely on continuous conscious effort to function within hierarchically structured environments. This leads to a chronic internal conflict between:

* “how I naturally process information” (non-hierarchical cognition), and
* “how I am expected to behave” (hierarchical social norms).

This persistent conflict generates a **chronic translation cost**, which accumulates over time and manifests as:

* severe mental fatigue,
* burnout,
* depressive symptoms,
* psychosomatic complaints,
* sudden breakdowns such as meltdowns or shutdowns.

Externally, individuals may appear competent or “high-functioning,” but internally they often operate near their cognitive limits.

### 3.3.5 A Less Common Variant: Hierarchical Cognition with Incomplete Implicit Processing

A less common but theoretically important variant of AuDHD arises from the opposite configuration.

In this case, individuals are **innately hierarchical in cognition** but possess only a moderate level of metacognition, leading them to attempt the acquisition of implicit, non-hierarchical social processing.

#### Structural Characteristics

**ASD-like features (hierarchical cognitive base):**

* strong preference for explicit rules and logical consistency,
* discomfort with ambiguity and contradiction,
* reliance on formalized reasoning.

**ADHD-like features (attempted implicit processing):**

* impulsive social responses while trying to “sense” unspoken norms,
* diffuse attention aimed at detecting implicit cues,
* excessive social monitoring and over-adaptation.

Here again, the defining feature is **incomplete adaptation**, rather than the presence of two independent disorders.

### 3.3.6 Two Structural Origins of AuDHD

The present theory clarifies that AuDHD has two possible structural origins:

1. **Non-hierarchical origin (more common):**
   Non-hierarchical cognition attempting to construct a hierarchical translation layer.

2. **Hierarchical origin (less common):**
   Hierarchical cognition attempting to acquire implicit, non-hierarchical processing.

In both cases, AuDHD emerges at the **moderate level of metacognition**, where partial understanding enables adaptation attempts, but insufficient control prevents their stabilization.

### 3.3.7 Why Metacognition Remains at a Moderate Level

The level of metacognition is shaped by a combination of factors:

* **genetic factors:** individual differences in self-monitoring capacity,
* **developmental factors:** sensitive periods for metacognitive growth,
* **environmental factors:** supportive environments versus environments that impose premature adaptation.

For many individuals with AuDHD, strong environmental pressure to “adapt” may have forced the construction of translation layers before full metacognitive development was possible. As a result, metacognition stabilizes at a moderate level, and chronic translation cost becomes embedded in daily life.
